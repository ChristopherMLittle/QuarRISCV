...
proc update_PARAM_VALUE.C_M00_CPU_ADDRSIZE { PARAM_VALUE.C_M00_CPU_ADDRSIZE } {
	# Procedure called to update C_M00_CPU_ADDRSIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_CPU_ADDRSIZE { PARAM_VALUE.C_M00_CPU_ADDRSIZE } {
	# Procedure called to validate C_M00_CPU_ADDRSIZE
	return true
}

proc update_PARAM_VALUE.C_M00_CPU_DATASIZE { PARAM_VALUE.C_M00_CPU_DATASIZE } {
	# Procedure called to update C_M00_CPU_DATASIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_CPU_DATASIZE { PARAM_VALUE.C_M00_CPU_DATASIZE } {
	# Procedure called to validate C_M00_CPU_DATASIZE
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_CPU_DATASIZE { MODELPARAM_VALUE.C_M00_CPU_DATASIZE PARAM_VALUE.C_M00_CPU_DATASIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_CPU_DATASIZE}] ${MODELPARAM_VALUE.C_M00_CPU_DATASIZE}
}

proc update_MODELPARAM_VALUE.C_M00_CPU_ADDRSIZE { MODELPARAM_VALUE.C_M00_CPU_ADDRSIZE PARAM_VALUE.C_M00_CPU_ADDRSIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_CPU_ADDRSIZE}] ${MODELPARAM_VALUE.C_M00_CPU_ADDRSIZE}
}
