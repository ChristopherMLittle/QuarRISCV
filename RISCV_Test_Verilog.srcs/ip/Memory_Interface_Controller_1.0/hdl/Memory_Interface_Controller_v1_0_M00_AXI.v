...
`timescale 1 ns / 1 ps
	...
	module Memory_Interface_Controller_v1_0_M00_AXI #
	(
	...
	(
        ...
        input wire [C_CPU_ADDRSIZE-1 : 0]      CC_DREQ_RADDR,
	    ...
	    if (M_AXI_ARESETN == 0)                                          
	      ...
	      begin  
	        ...
	        case(read_index)
	           2'b00:
	             begin
	               read_data[C_M_AXI_DATA_WIDTH-1:0] <= M_AXI_RDATA; 
	             end   
	           2'b01:
	             begin
	               read_data[C_M_AXI_DATA_WIDTH*2-1:C_M_AXI_DATA_WIDTH-1] <= M_AXI_RDATA; 
	             end
	           2'b10:
	             begin
	               read_data[C_M_AXI_DATA_WIDTH*3-1:C_M_AXI_DATA_WIDTH*2-1] <= M_AXI_RDATA; 
	             end   
	           2'b11:
	             begin
	               read_data[C_M_AXI_DATA_WIDTH*4-1:C_M_AXI_DATA_WIDTH*3-1] <= M_AXI_RDATA; 
	             end    
	           default:
	             begin
	               read_data <= read_data; 
...
//                        read_data <= Dread_data;
	              ...
	              begin                                                                                         
	                ...
	                if (write_enable && ~axi_awvalid && ~start_single_burst_write && ~burst_write_active)                       
	                  begin                                                                                     
